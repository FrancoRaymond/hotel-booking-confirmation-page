...
const MobileNavbar = () => {
  ...
  return (
    <div className='relative flex items-center justify-between bg-[#fbf6f0] py-2 md:hidden'>
        ...
        <nav className={`absolute border-t bg-[#fbf6f0] py-3 border-gray-300 flex flex-col top-14 left-0 w-full shadow-lg overflow-hidden transition-all duration-300 ease-in-out origin-top ${menuOpen ? 'h-screen opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-3 pointer-events-none'}`}>
            <ul>
                <li>
